...
Examples:
  python voice_analyser.py VivienneHD_FR.wav FR
  python voice_analyser.py HollyUK_EN.wav EN EthanUK_EN.wav EN
  python voice_analyser.py --precise RemyHD_FR.wav FR
